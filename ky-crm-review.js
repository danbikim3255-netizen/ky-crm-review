...
4. **이슈의 원인 규명에 직접 도움이 되는 발견만** 작성. 이슈와 무관한 설정값, 정상 동작 내역, 단순 존재 확인("~이 정의되어 있음"), 타임스탬프 나열, 버전 간 구조 차이 단순 언급("~와 구조가 상이함")은 모두 제외. 각 항목은 "• "로 시작하고 1줄로 간결하게. 인과관계가 있으면 다음 줄에 "→ " 접두어로 결론 기술.
